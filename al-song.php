...
<body>
    ...
    <?php
    $sql = "SELECT `SNAME`,`YEAR`,`S_ID`,`PATHS`,`IMAGE`,`ALIMAGE`,`ALNAME` FROM `song`,`album` WHERE song.ALID=$aid AND album.ALID=$aid";
    $sql1 = "SELECT `ALIMAGE`,`ALNAME` FROM `album` WHERE album.ALID=$aid";
