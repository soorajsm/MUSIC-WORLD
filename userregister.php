  ...
  <div class="form">
    <form action="" method="POST">
      ...
      <div class="input-container ic2">
        <input type="text" class="input" name="age" id="age" placeholder="" />
        <div class="cut"></div>
        <label class="placeholder" for="title">Age</label>
      </div>

      <div class="input-container ic2">
        <input type="text" class="input" name="gender" id="gender" placeholder="" />
        <div class="cut"></div>
      ...
      <div class="input-container ic2">
        <input type="password" class="input" name="password" class="password" placeholder="" />
        <div class="cut"></div>
        <label class="placeholder" for="title">Password</label>
      </div>
      <button  class="submit" type="submit">Add User</button>
    </form>
    <div class="">Already have an account? <a href="userlogin.php"> Log-in</a></div>
  </div>
...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO `user` (`UID`, `NAME`, `AGE`, `GENDER`, `EMAIL`, `password`) VALUES (NULL, '$username', '$age', '$gender', '$email', '$password');";
