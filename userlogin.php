...
<head>
    ...
    <!-- <link rel="stylesheet" href="trial.css?<?= time() ?>"> -->
    ...
    <div style="height: 350px;" class="form">
        <form action="" method="POST">
            <div class="input-container ic1">
                ...
                <div class="cut"></div>
                <label class="placeholder" for="title">Username</label>
            </div>
        ...
        <div style="margin: 20px 0 0 70px;">Don't have an account?<a style="color: blue;" href="userreg.php">Sign up</a>
        </div>
    </div>
